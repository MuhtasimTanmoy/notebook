...
part of this torrent. The format of the torrent file is bencoding.
 ...
 - name, piece length, pieces, and either length or file key.
...
- A file is split into equal-sized pieces, which are further divided into smaller blocks.
...
also need to know what pieces of content each peer in its peer set has. By knowing what
